...
$classes = ($active ?? false)
            ? 'block w-full ps-3 pe-4 py-2.5 bg-brand-500 border-2 border-terminal-950 rounded-lg shadow-retro-sm text-start text-base font-semibold text-terminal-950 transition'
