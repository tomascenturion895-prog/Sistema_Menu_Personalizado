...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-4 py-1.5 bg-brand-500 border-2 border-terminal-950 rounded-full shadow-retro-sm text-sm font-semibold text-terminal-950 transition'
