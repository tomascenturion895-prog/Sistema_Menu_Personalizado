...
<div>
    <div class="mb-6">
        <h1 class="font-display text-2xl uppercase text-terminal-950">Nueva contraseña</h1>
        <p class="text-sm text-gray-500 mt-1">Elegí una contraseña nueva para tu cuenta.</p>
    </div>
