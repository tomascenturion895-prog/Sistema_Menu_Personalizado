...
{{-- Navbar naranja de marca, mismo lenguaje retro que la landing y el login:
     logo con cursor, tabs tipo pildora (la activa es blanca con borde negro y sombra dura) --}}
<nav x-data="{ open: false }" class="bg-brand-500 border-b-2 border-terminal-950">
            ...
            <div class="flex items-center">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" wire:navigate>
                        <x-application-logo variant="onbrand" class="text-lg text-terminal-950" />
                    </a>
                </div>
